...
public class BookJAXB implements Serializable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        books.addBook(new Book(1, "XML Developer's Guide", "Matthew Gambardella", "Computer", 1, 40.0, "Good", publication1));
        books.addBook(new Book(2, "Exercise Physiology", "Mcardle", "Health", 1, 35.0, "fair", publication2));
        books.addBook(new Book(3, "The New Law of Torts", "Danuta Mendelson", "Legal", 1, 55.0, "fair", publication3));
